    ...
    const footer1 = (
      <div>
        <Button
          label="Yes"
          icon="pi pi-check"
          onClick={this.deleteAllBillItems}
        />
        <Button
          label="No"
          icon="pi pi-times"
                  ...
                  <tr className="custDetailRow">
                    ...
                    <td className="custDetailCol">
                      <input
                        ...
                        onChange={e =>
                          this.setState({ custPhoneNumber: e.target.value })
                        }
                      />
                    </td>
                  </tr>
              ...
              <table className="billListTable">
                <tbody>
                  <tr className="billListTableRow">
                    ...
                    <th className="billListTableHeading">
                      <span className="billListTableHeadingText">
                        Discount(%)
                      </span>
                    </th>
                    <th className="billListTableHeading">
                  ...
                  {this.state.items.map((item, index) => {
                    return (
                      <tr className="billListTableRow" key={index}>
                        ...
                        <td className="billListTableCol">
                          <span className="billListColText">
                            {item.medicine}
                          </span>
                        </td>
                        <td className="billListTableCol">
