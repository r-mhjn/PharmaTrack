...
export default class OrderBox extends React.Component {
  ...
  addToStock = async () => {
    ...
    for (let i = 0; i < this.state.items.length; i++) {
      ...
      expiryDate += this.state.items[i].expiryDate.toLocaleString().substring(0,10);
    ...
    await Axios.post("http://csichitkara.club/createmedicine", {
      mid: "id",
      mname: medicines,
      number: qty,
      mprice: price,
    ...
    const footer1 = (
      <div>
        <Button
          label="Yes"
          icon="pi pi-check"
          onClick={this.deleteAllListItems}
        />
        <Button
          label="No"
          icon="pi pi-times"
    ...
    const footer2 = (
      <div>
        <Button
          label="Yes"
          icon="pi pi-check"
          onClick={this.deleteFuctionCall}
        />
        <Button
          label="No"
          icon="pi pi-times"
          onClick={this.onHide2}
          className="p-button-secondary"
        />
      </div>
    );
              ...
              <table className="stockListTable">
                <tbody>
                  <tr className="stockListTableRow">
                    ...
                    <th className="stockListTableHeading">
                      <span className="stockListTableHeadingText">
                        Medicine
                      </span>
                    </th>
                    <th className="stockListTableHeading">
                    ...
                    return (
                      <tr key={index} className="stockListTableRow">
                        ...
                        <td className="stockListTableCol">
                          {item.expiryDate.toLocaleString().substring(0,10)}
                        </td>
                        <td className="stockListTableCol">
                          <Button
                            icon="pi pi-trash"
